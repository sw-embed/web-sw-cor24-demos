...
static PROJECTS: [ProjectRow; 41] = [
    ...
    ProjectRow {
        repo: "sw-cor24-hlasm",
        description: "High-level assembler (COR24 asm)",
    ...
    ProjectRow {
        repo: "sw-cor24-isa",
        description: "ISA specification and documentation",
        repo_status: green("Try it"),
        has_web_ui: neutral("n/a"),
        has_saga: false,
        is_web: false,
    ...
    ProjectRow {
        repo: "sw-cor24-ocaml",
        description: "OCaml compiler (Pascal, P-code target)",
    ...
    ProjectRow {
        ...
        description: "Prolog interpreter (PL/SW, WAM-like VM)",
        repo_status: orange("In plan"),
        has_web_ui: orange("Planned"),
        has_saga: false,
        is_web: false,
    ...
    ProjectRow {
        ...
        description: "RPG-II report generator (HLASM)",
        repo_status: yellow("In dev"),
        has_web_ui: orange("Planned"),
        has_saga: false,
        is_web: false,
    ...
    ProjectRow {
        ...
        description: "Smalltalk environment (BASIC)",
        repo_status: yellow("In dev"),
        has_web_ui: green("Try it"),
        has_saga: false,
        is_web: false,
    ...
    ProjectRow {
        repo: "sw-tos",
        description: "SWTOS microkernel (PL/SW)",
        repo_status: green("Try it"),
        has_web_ui: green("Try it"),
        has_saga: false,
        is_web: false,
    ...
    ProjectRow {
        ...
        description: "Fortran compiler web UI",
        repo_status: orange("In plan"),
        has_web_ui: neutral("n/a"),
        has_saga: false,
        is_web: true,
    ...
    ProjectRow {
        repo: "web-sw-tos",
        description: "SWTOS tiled terminal demo",
        repo_status: green("Try it"),
        has_web_ui: neutral("n/a"),
        has_saga: true,
        is_web: true,
